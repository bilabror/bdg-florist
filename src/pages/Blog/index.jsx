          ...
          <div className="flex gap-40">
            ...
            <div className="w-8/12">
              ...
              <div id="text" className="text-start">
                <div className="mb-8">
                  Waktu terbaik untuk menyiram tanaman adalah pagi hari, karena
                  akan memberi tanaman waktu untuk mengering sebelum malam hari.
                  Membiarkan air diam di tanaman semalaman bisa memicu
                  pertumbuhan jamur. Penyiraman di saat yang tepat dan dengan
                  menggunakan metode yang tepat akan menjaga tanaman Anda tetap
                  sehat.
                </div>
                ...
                <div className="mb-8">
                  ...
                  sebaiknya disiram sebelum sinar matahari terasa terlalu panas.
                  Tanaman yang terhidrasi akan lebih bisa bertahan dalam
                ...
                <div className="mb-8">
                  Jika pagi hari tidak memungkinkan, siram tanaman di sore hari.
                  Penyiraman di pagi hari mungkin akan sulit dilakukan ketika
                  ada segudang hal lainnya yang juga harus dilakukan. Jika Anda
                  tidak bisa menyiram di pagi hari, tunggu hingga sore hari,
                  saat sinar matahari sudah terasa tidak terlalu panas. Dengan
                  begitu, tanaman tidak akan terbakar dan air masih bisa diserap
                ...
                <div className="">
                  Jika Anda harus menyiram di siang hari, lakukan hanya sesekali
                  dan jangan buat jadi kebiasaan yang dilakukan setiap hari.
                </div>
                <div className="mb-8">
                  Jangan menyiram tanaman pada malam hari. Jika tanaman disiram
                  pada malam hari, air tidak akan menguap serta akan diam di
                  daun dan batang tanaman. Tanpa bantuan matahari, tanahnya
                  mungkin akan penuh dengan air dan air tidak akan terserap
                  dengan baik. Hal ini merugikan tanaman karena akan memicu
                  pertumbuhan jamur di sekitar akar, batang dan daun.
                </div>
                <div>
                  Siram tanaman di malam hari hanya jika terpaksa, yaitu ketika
                  tanaman Anda sangat membutuhkan air dan Anda tidak bisa
                  menunggu sampai pagi hari.
                </div>
                <div className="mb-8">
